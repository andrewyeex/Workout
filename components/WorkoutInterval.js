...
export default class WorkoutInterval extends Component {
  ...
  handleIncrementWorkoutActivityIndex = () =>
    this.setState(prevState => {
      ...
      return {
        ...
        progressCounter: this.workoutActivities[workoutActivityIndex]
          ? this.workoutActivities[workoutActivityIndex].duration
          : 0,
        progressTotal: this.workoutActivities[workoutActivityIndex]
          ? this.workoutActivities[workoutActivityIndex].duration
          : 0
      }
    })
  handleDecrementProgressCounter = () =>
    this.state.progressCounter > 0 &&
    this.setState(prevState => ({
      progressCounter: prevState.progressCounter - 1
    }))
  handleToggleShowIntro = () =>
    this.setState(prevState => ({showIntro: !prevState.showIntro}))
  ...
  render() {
    ...
    const {activities, handleSelectedWorkout, handleEndActivity} = this.props
    ...
    if (showIntro)
      ...
      return (
        <Activity
          ...
          handleIncrementWorkoutActivityIndex={
            this.handleIncrementWorkoutActivityIndex
          }
      ...
      return (
        <TouchableOpacity onPress={handleSelectedWorkout({})}>
          <Text>Congratulations, you finished!</Text>
        </TouchableOpacity>
      )
  }
}
